    ...
    return (
                            ...
                            <div className="recipe-set ">
                                <div className="wrapper-detail-contents">
                                    ...
                                    <div className="about-chef">
                                        <h3 className="lined">About Chef</h3>
                                        <div className="listing">
                                            <div className="image">
                                                <div className="image-inner">
                                                    <a href="/">
                                                        <img
                                                            src="images/temp-images/about-chef-detail.jpg"
                                                            alt="chef"
                                                        />
                                                    </a>
                                                </div>
                                            ...
                                            <div className="detail">
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-4">
                                                        <ul className="chef-social-links">
                                                            <li>
                                                                <a href="/">
                                                                    <i className="fa fa-facebook" />
                                                                </a>
                                                ...
                                                <a href="/" className="read-more-angle">
                                                    Read More
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="related-recipes">
                                        <h3 className="lined">Related Recipes</h3>
                                        <div className="boxed-recipes text-center">
                                            {/*single recipe*/}
                                            <div className="recipe-single">
                                                <div className="recipe-image">
                                                    <a href="/">
                                                        <img
                                                            src="images/temp-images/main-recipe1.jpg"
                                                            alt="image"
                                                        />
                                                    </a>
                                                </div>
                                            ...
                                            <div className="recipe-single">
                                                <div className="recipe-image">
                                                    <a href="/">
                                                        <img
                                                            src="images/temp-images/main-recipe2.jpg"
                                                            alt="image"
                                                        />
                                                    </a>
                                                </div>
                                            ...
                                            <div className="recipe-single">
                                                <div className="recipe-image">
                                                    <a href="/">
                                                        <img
                                                            src="images/temp-images/main-recipe3.jpg"
                                                            alt="image"
                                                        />
                                                    </a>
                                                </div>
      ...
      C26.561,14.999,24.337,16.239,23.049,18.313z"
                                    ...
                                    <div className="widget widget-measurements">
                                        ...
                                        <a className="default-btn small-button theme-color" href="/">
                                            Read More
                                        </a>
                                    </div>
                                    {/*widget overlay*/}
                                    <div className="widget widget-overlay">
                                        <a href="/">
                                            <figure>
                                                <img src="images/temp-images/image-overlay.jpg" alt="image" />
