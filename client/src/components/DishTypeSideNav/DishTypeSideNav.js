...
const DishTypeSideNav = () => {
                ...
                <div className="side-bar">
                    ...
                    <div className="widget recipe-search">
                        <div className="category-list">
                            ...
                            <ul>
                                <li>
                                    <Link to="/recipe-listing?dishType=Breakfast">breakfast</Link>
	...
	c0-0.828,0.672-1.499,1.5-1.499S13,18.672,13,19.5C13,20.329,12.329,21.001,11.5,21.001L11.5,21.001z"
                                ...
                                <li>
                                    <Link to="/recipe-listing?dishType=Starter">Starter</Link>
                                    <div className="list-icons">
                                        <svg
                                            version="1.1"
                                            className="icon-container"
	...
	c-0.553,0-1,0.448-1,1C14,9.552,14.447,9.998,15,9.998z"
                                ...
                                <li>
                                    <Link to="/recipe-listing?dishType=Lunch">lunch</Link>
                                    <div className="list-icons">
                                        <svg
                                            version="1.1"
                                            className="icon-container"
		...
		c3.524,2.025,10.662,3.07,17.741,3.07s14.217-1.045,17.74-3.07C37.334,33.452,29.926,39.988,21,39.988z"
                                ...
                                <li>
                                    <Link to="/recipe-listing?dishType=Dinner">dinner</Link>
                                    <div className="list-icons">
                                        <svg
                                            version="1.1"
                                            className="icon-container"
	...
	c1.105,0,2.001,0.89,2.001,1.987C18.009,17.1,17.112,17.99,16.007,17.99L16.007,17.99z"
                                ...
                                <li>
                                    <Link to="/recipe-listing?dishType=Dessert">dessert</Link>
                                    <div className="list-icons">
                                        <svg
                                            version="1.1"
                                            className="icon-container"
...
export default DishTypeSideNav;