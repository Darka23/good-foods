            ...
            <fieldset>
              <div className="inner-advance-search">
                <div className="form-field">
                  ...
                  >
                    <option value="ing1" selected="selected">
                      Any Ingredient
                    </option>
                ...
                <div className="row">
                  <div className="col-sm-6">
                    ...
                    <select
                      ...
                      className="advance-selectable"
                    >
                      <option value="t0" selected="selected">
                        None
                      </option>
                  ...
                  <div className="col-sm-6">
                    ...
                    <select
                      ...
                      className="advance-selectable"
                    >
                      <option value="c0" selected="selected">
                        None
                      </option>
                      <option value="c1">type 1</option>
                      <option value="c2">type 2</option>
                      <option value="c3">type 3</option>
                      <option value="c4">type 4</option>
                    </select>
                  </div>
                  <div className="col-sm-6">
                    ...
                    <select
                      ...
                      className="advance-selectable"
                    >
                      <option value="cr0" selected="selected">
                        None
                      </option>
                      <option value="cr1">type 1</option>
                      <option value="cr2">type 2</option>
                      <option value="cr3">type 3</option>
                      <option value="cr4">type 4</option>
                    </select>
                  </div>
                  <div className="col-sm-6">
